...
<body class="h-screen flex overflow-hidden text-sm">
    ...
    <aside class="w-64 bg-brand-sidebar flex flex-col border-r border-brand-border z-20 shrink-0">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-4 flex flex-col gap-1">
            <a href="#" class="flex items-center px-3 py-2.5 bg-brand-blue text-white rounded-lg group mb-2">
            ...
            <a href="#" class="flex items-center justify-between px-3 py-2.5 text-brand-text hover:text-white hover:bg-white/5 rounded-lg transition-colors">
                ...
                <span class="bg-brand-red text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">1</span>
            </a>
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-6 bg-brand-bg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-[#2D1619] border border-brand-red/30 rounded-xl p-4 flex items-center relative overflow-hidden">
                    ...
                    <div class="w-12 h-12 rounded-full bg-brand-red flex items-center justify-center mr-4 z-10 shadow-[0_0_15px_rgba(239,68,68,0.5)]">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.64 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2zm-2 1H8v-6c0-2.48 1.51-4.5 4-4.5s4 2.02 4 4.5v6z"/></svg>
                    </div>
                    <div class="z-10">
                        <div class="text-[10px] font-bold text-white uppercase tracking-wider mb-1">ACTIVE CRITICAL ALERTS</div>
                        <div class="text-3xl font-bold text-white leading-none mb-1">1</div>
                ...
                <div class="bg-brand-card border border-brand-border rounded-xl p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-white leading-none mb-1">1</div>
                ...
                <div class="bg-brand-card border border-brand-border rounded-xl p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-bold text-white leading-none mb-1">3</div>
            ...
            <div class="bg-gradient-to-r from-[#2a1318] to-brand-card border border-brand-red/40 rounded-xl mb-6 flex items-stretch overflow-hidden relative shadow-[0_0_30px_rgba(239,68,68,0.1)]">
                ...
                <div class="w-1/4 p-6 flex flex-col items-center justify-center border-r border-brand-border/30 relative z-10">
                    <div class="relative w-32 h-32 flex items-center justify-center">
                        ...
                        <div class="w-20 h-20 bg-brand-red rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(239,68,68,0.8)] z-10">
                            <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2c-4.97 0-9 4.03-9 9 0 3.86 2.43 7.15 5.91 8.46l.09.04V22h6v-2.5l.09-.04C18.57 18.15 21 14.86 21 11c0-4.97-4.03-9-9-9zm0 2c3.86 0 7 3.14 7 7 0 2.89-1.74 5.38-4.26 6.45L14 17.75V19h-4v-1.25l-.74-.3C6.74 16.38 5 13.89 5 11c0-3.86 3.14-7 7-7zm-1 3v5h2V7h-2zm0 7v2h2v-2h-2z"/></svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-1 p-8 z-10">
                    ...
                    <h2 class="text-3xl font-bold text-white mb-6">Emergency Incoming!</h2>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center text-brand-text">
                            ...
                            <span class="text-base text-white">Engineering Building</span>
                        </div>
                        <div class="flex items-center text-brand-text">
                            <svg class="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                            <span class="text-base">May 15, 2025 <span class="mx-2">|</span> 10:28 AM</span>
                        </div>
                        <div class="flex items-center text-brand-text">
                            <svg class="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <div class="bg-brand-card border border-brand-border rounded-xl flex flex-col">
                        <div class="px-5 py-4 flex items-center justify-between border-b border-brand-border">
                            <h2 class="text-xs font-bold text-white uppercase tracking-wider">ACTIVE CRITICAL ALERTS</h2>
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody class="text-xs text-brand-white">
                                    <tr class="hover:bg-white/5 transition-colors bg-brand-red/5">
                                        <td class="px-5 py-3 text-brand-text">1</td>
                                        <td class="px-5 py-3 font-medium">10:28 AM</td>
                                        <td class="px-5 py-3 text-white">Engineering Building</td>
                    ...
                    <div class="bg-brand-card border border-brand-border rounded-xl flex flex-col flex-1">
                        <div class="px-5 py-4 flex items-center justify-between border-b border-brand-border">
                            <h2 class="text-xs font-bold text-white uppercase tracking-wider">ALERT HISTORY (TODAY)</h2>
                            <a href="#" class="text-[10px] text-brand-blue hover:text-blue-400">View All</a>
                        </div>
                            ...
                            <table class="w-full text-left border-collapse">
                                ...
                                <tbody class="text-xs text-brand-white">
                                    <tr class="border-b border-brand-border/50 hover:bg-white/5 transition-colors">
                                        ...
                                        <td class="px-5 py-3 text-white">Yes</td>
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <div class="bg-brand-card border border-brand-border rounded-xl flex flex-col">
                        <div class="px-5 py-4 flex items-center justify-between border-b border-brand-border">
                            <h2 class="text-xs font-bold text-white uppercase tracking-wider">CLINIC ALARM STATUS</h2>
                        ...
                        <div class="p-5 flex items-center">
                            ...
                            <div>
                                <div class="text-white font-bold text-sm mb-1">Alarm System Active</div>
                    ...
                    <div class="bg-brand-card border border-brand-border rounded-xl flex flex-col">
                        <div class="px-5 py-4 flex items-center justify-between border-b border-brand-border">
                            <h2 class="text-xs font-bold text-white uppercase tracking-wider">EQUIPMENT READINESS</h2>
                            <a href="#" class="text-[10px] text-brand-blue hover:text-blue-400">View All</a>
                        </div>
                    ...
                    <div class="bg-brand-card border border-brand-border rounded-xl flex flex-col">
                        ...
                        <div class="p-4 grid grid-cols-2 gap-3">
                            <button class="bg-[#31165A] border border-[#5B21B6]/50 hover:bg-[#4C1D95] text-white rounded-lg flex items-center justify-center py-3 px-2 transition-colors">
