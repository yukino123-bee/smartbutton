...
<body class="bg-slate-900 text-slate-200 font-sans min-h-screen flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full bg-slate-800 rounded-xl shadow-2xl border border-slate-700 overflow-hidden my-8">
        <div class="p-8 text-center bg-slate-900/50 border-b border-slate-700">
            ...
            <h1 class="text-xl font-bold text-brand-dark mb-2">Create an Account</h1>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <select id="role" name="role" required
                        ...
                        <option value="DRRMO" {{ old('role') == 'DRRMO' ? 'selected' : '' }}>DRRMO</option>
                ...
                <button type="submit"
                    class="w-full bg-blue-600 hover:bg-blue-700 text-brand-dark font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-slate-900 mt-2">
                    Create Account
                </button>
