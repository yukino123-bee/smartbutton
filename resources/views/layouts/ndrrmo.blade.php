...
<body class="h-screen flex overflow-hidden text-sm">
    ...
    <aside class="w-64 bg-brand-sidebar flex flex-col border-r border-brand-border z-20 shrink-0">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar p-4 flex flex-col gap-1">
            ...
            <a href="{{ route('ndrrmo.users') }}" class="flex items-center px-3 py-2.5 {{ request()->routeIs('ndrrmo.users') ? 'bg-brand-blue text-white' : 'text-brand-text hover:text-white hover:bg-white/5' }} rounded-lg transition-colors">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                <span class="font-medium">Users</span>
            </a>

            <a href="{{ route('ndrrmo.settings') }}" class="flex items-center px-3 py-2.5 {{ request()->routeIs('ndrrmo.settings') ? 'bg-brand-blue text-white' : 'text-brand-text hover:text-white hover:bg-white/5' }} rounded-lg transition-colors">
